...
export default class restAPI extends Component {
    ...
    sendButton = () => {         // Sends All Data
        fetch("http://localhost:3000/meeting", {
            ...
            body: JSON.stringify({ name: this.name, date: this.date })
        })
            .then((responseData) => {
                return responseData.json();
            })
    ...
    updateButton = () => {         // Update Data by ID
        fetch("http://localhost:3000/meeting", {
            ...
            body: JSON.stringify({ name: this.name, date: this.date, id: this.dataId})
        })
            .then((responseData) => {
                return responseData.json();
            })
        ...
        return (
            <View style={styles.container}>
                ...
                <View>
                    ...
                    <TextInput style={styles.input}         //date Input
                        onChangeText={(text) => {
                                this.date = text
                        }}
                        value={this.date}
